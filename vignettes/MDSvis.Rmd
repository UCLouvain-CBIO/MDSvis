...
`CytoMDS` package (@Hauchamps2025-zm). For more information see the [`CytoMDS` vignette](https://www.bioconductor.org/packages/release/bioc/vignettes/CytoMDS/inst/doc/CytoMDS.html).  
...
where the units of interest are not necessarily cytometry samples. 
...
We save the newly created objects as .rds files. These files can now 
be selected within the shiny app for visualization.
